---
description: Test RIGHT motor BACKWARD (TEST_PWM, PID-bypassed) and verify encoder counts down
allowed-tools: Bash(ssh navbot-pi:*)
---

Test the **RIGHT motor driving BACKWARD** on the navbot (RP2040 fw 1.3.0, motor M1).
...
Interpret: PASS = RIGHT delta clearly negative (< ~−50), LEFT ~0, no `FAULT STALL`. Report plainly; leave motors stopped.
